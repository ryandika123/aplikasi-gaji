<div class="container-fluid">
	<div class="card mx-auto" style="width:35%">
		...
		<form method="post" action="<?php echo base_url('admin/slipGaji/cetakslip') ?>">
		<div class="card-body">
			<div class="form-group row">
 			 ...
 			 <button type="submit" style="width: 100%" class="btn  btn-primary"><i class="fas fa-print">  Cetak Slip Gaji</i></button>
		</div>
	</div>
	</form>
</div>